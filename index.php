...
<head>
  ...
  <title>PROTUR Solicitudes</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="images/favicon-16x16.png" class="logo">
      ...
      <span class="logo-mini"><b>PP</b>SS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Protur</b>Solicitudes</span>
    </a>
...
<!--        Optionally, you can add icons to the links-->
        <li class="active"><a href="#" id="solicitudes"><i class="fa fa-link"></i> <span>Solicitudes</span></a></li>
        <li><a href="#"><i class="fa fa-link"></i> <span>Estadísticas</span></a></li>
...
<!--js para funciones particulares a este archivo-->
